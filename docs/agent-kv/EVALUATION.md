...
| Canonical single-tool history does not provide a fully reusable APC block through the assistant semantic end | `experimentally validated` (negative) | `scripts/run_a01.py`, [A0.1 result report](../../experiments/0001-mechanism-feasibility/A0.1-results-2026-07-22.md) | One hand-authored fixture; Qwen2.5-7B-Instruct revision `a09a35458c702b33eeacc393d103063234e8bc28`; vLLM `0.25.1` commit `752a3a504485790a2e8491cacbb35c137339ad34`; NVIDIA A10 | Local ignored bundle `experiments/0001-mechanism-feasibility/raw/a0.1/a01-20260721T190035Z-span-v2/`; tracked SHA-256 list in report | `semantic_span_equal=true`, but ceiling `192 < a_end 198`; no APC hit/miss, CPU restore, lifecycle-runtime, or performance inference; original D026 branch decision was superseded by the separate A0.1R admission evidence |
| Eligible full-block prefix can materialize as a stock APC hit without pressure | `experimentally validated` | [A0.1R result report](../../experiments/A0.1R-partial-block-residual/A0.1R-results-2026-07-22.md) | Same pinned Qwen/vLLM/A10 family; three independent cold ordinals | Local ignored A0.1R bundles; tracked hashes in report | `R0.cached=0`, `R1.cached=192=C`; admission only, no pressure, offload, performance, or runtime claim |
| Frozen stock APC/native-offload capacity-pressure gate has no registered Stop/Continue outcome | `experimentally validated` (`inconclusive`) | [A0.2 result report](../../experiments/A0.2-stock-sufficiency/A0.2-stock-sufficiency-results-2026-07-23.md), [machine summary](../../experiments/A0.2-stock-sufficiency/results/attempt-02/a02-matrix-summary.json) | Synthetic capacity pressure; `L={2048,8192,16384}`; three M bands; five pairs; S0/S1; pinned Qwen/vLLM/A10/HND; 3151 GPU KV blocks | 90 local ignored Attempt 2 bundles / 630 JSON with hashes in machine summary; Attempt 1 preserved as provenance-invalid | Three material S0 full-miss cells were all covered by attributable S1 restore; no material direction reversal; transfer overlap unobservable; no A1, real tool-gap, lifecycle-runtime, or performance claim |
