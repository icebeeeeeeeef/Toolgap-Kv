...
| 2048 | target | `{"full_recompute": 5}` | `{"mixed_cpu_restore": 5}` | 413.974 | 5.000 | True |
| 2048 | overload | `{"full_recompute": 5}` | `{"mixed_cpu_restore": 5}` | 420.600 | 5.000 | True |
| 8192 | low | `{"gpu_local_hit": 5}` | `{"gpu_local_hit": 5}` | - | 5.000 | False |
| 8192 | target | `{"partial_gpu_hit": 5}` | `{"mixed_cpu_restore": 5}` | - | 5.000 | False |
| 8192 | overload | `{"full_recompute": 5}` | `{"mixed_cpu_restore": 5}` | 1864.917 | 5.000 | True |
